...
public class ChangingPeople {
	// ---------------------------------------------------------
	// Sets up two person objects, one integer, and one String object.
	// These are sent to a method that should make some changes.
	// ---------------------------------------------------------
	public static void main(String[] args) {
		...
		// variables to create new person - Jill
		int age = 21;
		String name = "Jill";
	...
	// -----------------------------------------------------------------------------
	// Change the first actual parameter to "Jack - Age 101" and change the second
	// actual parameter to be a person with the age and name given in the third and
	// fourth parameters.
	// -----------------------------------------------------------------------------
